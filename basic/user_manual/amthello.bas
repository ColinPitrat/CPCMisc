5 delay=500
10 REM Amthello by M.J. Gribbins
...
690 FOR t=1 TO delay:NEXT t
700 GOTO 510
710 e%=e%:d%=d%:vrx%=vrx%
720 CLS#1:PRINT #1,"You played line number";e%
...
930 FOR t=1 TO delay:NEXT t:GOTO 1550
...
980 FOR t=1 TO delay:NEXT t:GOTO 1550
990 GOTO 400
...
1070 IF c%(c3%,c4%)=q% THEN GOTO 1080 ELSE 1090
...
1440 CLS #1:PRINT #1,"You must pass":FOR t=1 TO delay:NEXT t:GOTO 770
1450 GOTO 400
1460 FOR i%=1 TO 8
1470 FOR j%=1 TO 8
...
1640 FOR t=1 TO delay:NEXT t:END
1650 CLS #1:LOCATE #1,5,1:PRINT #1,"YOU HAVE";CQ%;"SQUARES, I HAVE";CN%
1660 LOCATE #1,17,3:PRINT #1,"I WON !!!"
1670 FOR t=1 TO 10*delay:NEXT t:END
1680 CLS #1:LOCATE #1,5,1:PRINT #1,"YOU HAVE";CQ%;"SQUARES, I HAVE";CN%
1690 LOCATE #1,16,3:PRINT #1,"YOU WON !!!"
1700 FOR t=1 TO 10*delay:NEXT t:END
